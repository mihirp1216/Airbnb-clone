    ...
    return (
        <div className='home'>
            ...
            <div className="home__section">
                ...
                <Card src="https://thespaces.com/wp-content/uploads/2017/08/Courtesy-of-Airbnb.jpg" title= "Penthouse in United States" description="Enjoy the amazing sights of United States with this stunning penthouse" price="$350/night"/>
                <Card src="https://media.nomadicmatt.com/2018/apartment.jpg" title= "1 Bedroom apartment" description="Superhost with great amenities and a fabolous shopping complex nearby" price="$80/night"/>
            </div>
        </div>                        
    )
}
